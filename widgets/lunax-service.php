...
class Lunax_Service extends Widget_Base {

	public function get_name() {
		return 'lunax--service';
	}

	public function get_title() {
		return esc_html__( 'Lunax Service', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax-service', LUNAX_ESSENTIAL_ASSETS_URL . 'css/lunax-service.css' );
	...
	public function register_content_controls() {
		$this->start_controls_section(
			'sec_content',
			[
				'label' => __( 'Service', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => esc_html__( '01', 'lunax-essential' ),
                'condition' => [
                        'service_style' => '1',
                ],
			]
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Service Title', 'lunax-essential' ),
                'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'rows' => 3,
				'default' => esc_html__( 'we approach each project with meticulous attention to detail and best quality.', 'lunax-essential' ),
			]
		);
	...
	public function register_style_controls() {
		...
		$this->add_control(
			'num_h_color',
			[
				'label' => esc_html__( 'Number Color', 'lunax-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'title_h_color',
			[
				'label' => esc_html__( 'Title Color', 'lunax-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'desc_h_color',
			[
				'label' => esc_html__( 'Desc Color', 'lunax-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'overlay_color',
			[
				'label' => esc_html__( 'Overlay Color', 'lunax-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'overlay_opacity',
			[
				'label' => esc_html__( 'Opacity', 'lunax-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        <div class="a-service--item style-<?php echo esc_html( $settings['service_style'] ); ?>">
            ...
            <div class="btn-wrapper">
		        <?php if ( '1' === $settings['service_style'] ): ?>
                    <a <?php $this->print_render_attribute_string( 'btn_link' ); ?> class="a-btn-circle" aria-label="<?php echo esc_attr__('Read Service Details', 'lunax-essential'); ?>">
