...
class Header_Menu extends Widget_Base {
	...
	// 	wp_register_style( 'info-header-menu', LUNAX_ESSENTIAL_ASSETS_URL . 'css/header.css' );
	// 	return [ 'info-header-menu' ];
	// }
	
	public function get_script_depends() {
	    wp_register_script( 'wdb-header-menu', LUNAX_ESSENTIAL_ASSETS_URL. '/js/widgets/header-menu.js' , [ 'jquery','meanmenu' ], false, true );
		return [ 'wdb-header-menu' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'layout_style',
			[
				'label' => esc_html__( 'Layout Style', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'athletic__header-menu',
				'options' => [
					'athletic__header-menu' => esc_html__( 'Athletic', 'lunax-essential' ),
					'fashion__header-menu' => esc_html__( 'Fasion', 'lunax-essential' ),					
				],
			]
		);
        ...
        $this->add_control(
			'show_offcanvas',
			[
				'label' => esc_html__( 'Show menu in Offcanvas', 'lunax-essential' ),
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'space-around'     => [
                        'title' => esc_html__('Around', 'lunax-essential'),
                        'icon'  => 'eicon-justify-space-around-h',
                    ],                     
                    'space-between'     => [
                        'title' => esc_html__('between', 'lunax-essential'),
                        'icon'  => 'eicon-justify-space-between-h',
                    ],                    
                    'space-evenly'     => [
                        'title' => esc_html__('evenly', 'lunax-essential'),
		...
		$this->add_responsive_control(
			'item_gap',
			[
				'label' => esc_html__( 'Menu Gap', 'lunax-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Offcanvas Content', 'lunax-essential' ),
				'condition' => [
                    'content_source' => 'self',
                ],
			]
			...
			$this->add_control(
				'show_gallery',
				[
					'label'        => esc_html__( 'Show Gallery', 'lunax-essential' ),
					'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'show_socials',
			[
				'label' => esc_html__( 'Show Social Icon', 'lunax-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'lunax-essential' ),
				'label_off' => esc_html__( 'Hide', 'lunax-essential' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Icon Settings', 'lunax-essential' ),
			]
		);	
			...
			$this->add_responsive_control(
				'icon_height',
				[
					'label' => esc_html__( 'Icon Height', 'lunax-essential' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px', 'em', 'rem' ],
					'range' => [
						'px' => [
			...
			$this->start_controls_tabs( 'arrowicon' );
				...
				$this->start_controls_tab( 'arrownormal',
					...
					$this->add_responsive_control(
						'dearrow_iucon_width',
						[
							'label' => esc_html__( 'Svg Width', 'lunax-essential' ),
							'type' => \Elementor\Controls_Manager::SLIDER,
							'size_units' => [ 'px', 'em', 'rem' ],
							'range' => [
								'px' => [
