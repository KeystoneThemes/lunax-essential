 ...
 * @since 1.0.0
 */
class Lunax_Side_Header extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Side Header', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax--header', LUNAX_ESSENTIAL_ASSETS_URL . 'css/side-header.css' );
		wp_register_style( 'lunax--button', LUNAX_ESSENTIAL_ASSETS_URL . 'css/lunax-button.css' );
		return [ 'lunax--header', 'lunax--button' ];
	}

	public function get_script_depends() {
		wp_register_script( 'lunax--header', LUNAX_ESSENTIAL_ASSETS_URL . '/js/widgets/side-header.js', [ 'jquery' ], false, true );
		return [ 'swiper', 'lunax--header' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'menu_selected',
			[
				'label' => esc_html__( 'Select Menu', 'lunax-essential' ),
		...
		$this->add_control(
			'mobile_close',
			[
				'label' => esc_html__( 'Mobile Menu Close Icon', 'lunax-essential' ),
				'type' => Controls_Manager::ICONS,
				'skin' => 'inline',
				'label_block' => false,
			]
		...
		$this->add_control(
			'header_position',
			[
				'label' => esc_html__( 'Header Position', 'lunax-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'prefix_class' => 'h-pos-',
				'options' => [
					'' => esc_html__( 'Default', 'lunax-essential' ),
					'fixed' => esc_html__( 'Fixed', 'lunax-essential' ),
				],
				'selectors' => [
					'{{WRAPPER}} .lunax--side-header' => 'position: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'normal',
				'options' => [
					'normal' => esc_html__( 'Default', 'lunax-essential' ),
					'exclusion' => esc_html__( 'Blend', 'lunax-essential' ),
				],
				'selectors' => [
					'{{WRAPPER}} .lunax--side-header' => 'mix-blend-mode: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lunax--side-header' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .lunax--side-header',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .lunax--side-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function menu_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lunax--side-menu a' => 'color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .lunax--side-menu a:hover' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
			...
			[
				'name' => 'menu_typo',
				'selector' => '{{WRAPPER}} .lunax--side-menu a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .lunax--side-menu a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'dd_open_size',
			[
				'label' => esc_html__( 'Dropdown Open Icon Size', 'lunax-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'dd_close_size',
			[
				'label' => esc_html__( 'Dropdown Close Icon Size', 'lunax-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function sub_menu_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .lunax--side-menu .sub-menu a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .lunax--side-menu .sub-menu a:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'sub_menu_typo',
				'selector' => '{{WRAPPER}} .lunax--side-menu .sub-menu a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .lunax--side-menu .sub-menu a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	public function button_controls() {
		$this->start_controls_section(
			'lunax_sec_button',
			[
				'label' => __( 'Button', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'      => 'row',
				'options'      => [
					'row'         => esc_html__( 'After', 'lunax-essential' ),
					'row-reverse' => esc_html__( 'Before', 'lunax-essential' ),
				],
				'selectors'    => [
	...
	protected function mobile_style_controls() {
		$this->start_controls_section(
			'lunax_style_mobile',
			[
				'label' => esc_html__( 'Mobile', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'mobile_off_menu_bg',
			[
				'label' => esc_html__( 'Menu Background Color', 'lunax-essential' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .lunax--side-header.mobile' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		$args = [
			'menu'            => $menu_selected,
			'container'       => 'nav',
			'container_class' => 'lunax--side-menu',
