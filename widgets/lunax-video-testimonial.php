 ...
 * @since 1.0.0
 */
class Lunax_Video_Testimonial extends Widget_Base {
	...
	public function get_name() {
		return 'lunax--video-testimonial';
	}
	...
	public function get_title() {
		return esc_html__( 'Lunax Video Testimonial', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax-video-testimonial', LUNAX_ESSENTIAL_ASSETS_URL . 'css/video-testimonial.css' );
		return [ 'lunax-video-testimonial' ];
	}

	public function get_script_depends() {
		wp_register_script( 'lunax-video-testimonial', LUNAX_ESSENTIAL_ASSETS_URL. '/js/widgets/video-testimonial.js' , [ 'jquery' ], false, true );
		return ['swiper', 'magnific-popup', 'lunax-video-testimonial' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Video Testimonial', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			'vtm_play_icon',
			[
				'label' => esc_html__( 'Video Play Icon', 'lunax-essential' ),
		...
		$this->start_controls_section(
			'sec_style_vtm_image',
			[
				'label' => esc_html__( 'Video', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'style_vtm_play',
			[
				'label' => esc_html__( 'Play Icon', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'play_wrap_size',
			[
				'label' => esc_html__( 'Wrapper Size', 'lunax-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'lunax_vtm_slider ' . $swiper_class,
