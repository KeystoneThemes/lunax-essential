 ...
 * @since 1.0.0
 */
class Lunax_Video extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Video', 'lunax-essential' );
	}
	...
	public function get_script_depends() {
		wp_register_script( 'lunax-video', LUNAX_ESSENTIAL_ASSETS_URL. '/js/widgets/video.js' , [ 'jquery' ], false, true );
		return [ 'lunax-video' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .lunax--video' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
