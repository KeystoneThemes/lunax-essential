 ...
 * @since 1.0.0
 */
class Lunax_Service_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Service Slider', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax--service-slider', LUNAX_ESSENTIAL_ASSETS_URL . 'css/service-slider.css' );

		return [ 'lunax--service-slider' ];
	}

	public function get_script_depends() {
		wp_register_script( 'lunax--service-slider', LUNAX_ESSENTIAL_ASSETS_URL . '/js/widgets/service-slider.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'lunax--service-slider' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'sec_bss_content',
			[
				'label' => esc_html__( 'Service', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			'bss_sec_title',
			[
				'label'       => esc_html__( 'Section Title', 'lunax-essential' ),
		...
		$repeater->add_control(
			'bss_image',
			[
				'label'   => esc_html__( 'Choose Image', 'lunax-essential' ),
		...
		$repeater->add_control(
			'bss_btn_link',
			[
				'label'       => esc_html__( 'Button Link', 'lunax-essential' ),
		...
		$this->add_control(
			'bss_list',
			[
				'label'   => esc_html__( 'Services', 'lunax-essential' ),
	...
	private function slider_controls() {
		...
		$this->add_control(
			'mousewheel',
			[
				'label'       => esc_html__( 'Mousewheel', 'lunax-essential' ),
				'description' => esc_html__( 'If you want to use mousewheel, please disable loop.', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'both',
				'options'   => [
					'both'   => esc_html__( 'Arrows & Fraction', 'lunax-essential' ),
					'arrows' => esc_html__( 'Arrows', 'lunax-essential' ),
					'dots'   => esc_html__( 'Fraction', 'lunax-essential' ),
	...
	public function register_style_btn_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Icon', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'btn_icon_width',
			[
				'label'     => esc_html__( 'Circle Width', 'lunax-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 100,
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'lunax_service_slider ' . $swiper_class,
