...
class WDB_Line extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Line', 'lunax-essential' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'options' => [
					'solid' => esc_html__( 'Default', 'lunax-essential' ),
					'dashed' => esc_html__( 'Dashed', 'lunax-essential' ),
					'dotted' => esc_html__( 'Dotted', 'lunax-essential' ),
					'double' => esc_html__( 'Double', 'lunax-essential' ),
				],
				'selectors' => [
