 ...
 * @since 1.0.0
 */
class Lunax_Testimonial extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Testimonial', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax-testimonial', LUNAX_ESSENTIAL_ASSETS_URL . 'css/lunax-testimonial.css' );
		return [ 'lunax-testimonial' ];
	}

	public function get_script_depends() {
		wp_register_script( 'lunax-testimonial', LUNAX_ESSENTIAL_ASSETS_URL . '/js/widgets/lunax-testimonial.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'lunax-testimonial' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Testimonial', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			'element_list',
			[
				'label'   => esc_html__( 'Testimonial Style', 'lunax-essential' ),
		...
		$repeater->add_control(
			'top_text',
			[
				'label' => esc_html__( 'Top Text', 'lunax-essential' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Default Text ', 'lunax-essential' ),
			]
		);
		...
		$repeater->add_control(
			'testimonial_content',
			[
				'label'   => esc_html__( 'Feedback', 'lunax-essential' ),
		...
		$repeater->add_control(
			'testimonial_image',
			[
				'label'   => esc_html__( 'Client Image', 'lunax-essential' ),
		...
		$repeater->add_control(
			'testimonial_quote',
			[
				'label'   => esc_html__( 'Choose Quote', 'lunax-essential' ),
				'type'    => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'testimonial_logo',
			[
				'label'   => esc_html__( 'Logo/Rating Image', 'lunax-essential' ),
				'type'    => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'testimonial_job',
			[
				'label'       => esc_html__( 'Designation', 'lunax-essential' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
		...
		$this->add_control(
			'testimonials',
			[
				'label'   => esc_html__( 'Testimonials', 'lunax-essential' ),
		...
		$this->start_controls_section(
			'section_slide_style',
			[
				'label' => esc_html__( 'Slide', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .lunax__testimonial-1 .slide::after, {{WRAPPER}} .lunax__testimonial-2 .slide::after'  => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'top_c_padding',
			[
				'label'      => esc_html__( 'Content Padding', 'lunax-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'separator' => 'before',
				'selectors'  => [
		...
		$this->add_responsive_control(
			'client_padding',
			[
				'label'      => esc_html__( 'Client Padding', 'lunax-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'top_text_show',
			[
				'label'     => esc_html__( 'Top Text Show', 'lunax-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'none',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'lunax-essential' ),
					'block' => esc_html__( 'Show', 'lunax-essential' ),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'img_show',
			[
				'label'     => esc_html__( 'Image Show', 'lunax-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'block',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'lunax-essential' ),
		...
		$this->start_controls_section(
			'sec_style_tm_quote',
			[
				'label' => esc_html__( 'Quote', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'quote_show',
			[
				'label'     => esc_html__( 'Quote Show', 'lunax-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'block',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'lunax-essential' ),
		...
		$this->start_controls_section(
			'sec_style_tm_logo',
			[
				'label' => esc_html__( 'Logo/Rating', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => ['3', '4'],
				],
	...
	private function slider_controls() {
		...
		$this->add_control(
			'slide_effect',
			[
				'label'   => esc_html__( 'Effect', 'lunax-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'slide',
				'options' => [
					'slide'     => esc_html__( 'Slide', 'lunax-essential' ),
					'cards'     => esc_html__( 'Cards', 'lunax-essential' ),
					'flip'      => esc_html__( 'Flip', 'lunax-essential' ),
					'fade'      => esc_html__( 'Fade', 'lunax-essential' ),
					'cube'      => esc_html__( 'Cube', 'lunax-essential' ),
					'coverflow' => esc_html__( 'CoderFlow', 'lunax-essential' ),
					'creative'  => esc_html__( 'Creative', 'lunax-essential' ),
				],
			]
		);
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Arrows', 'lunax-essential' ),
		...
		$this->add_control(
			'dots_active_size',
			[
				'label'     => esc_html__( 'Active Size', 'lunax-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 5,
		...
		$this->add_responsive_control(
			'dots_left',
			[
				'label'      => esc_html__( 'Spacing Left', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'lunax_testimonial_wrapper lunax__testimonial-' . $settings['element_list'] ],
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'lunax_testimonial_slider ' . $swiper_class,
