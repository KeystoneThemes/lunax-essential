 ...
 * @since 1.0.0
 */
class Lunax_Case_Study_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Case Study', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax-case-study', LUNAX_ESSENTIAL_ASSETS_URL . 'css/lunax-case-study-slider.css' );
		return [ 'lunax-case-study' ];
	}

	public function get_script_depends() {
		wp_register_script( 'lunax-case-study', LUNAX_ESSENTIAL_ASSETS_URL . '/js/widgets/lunax-case-study-slider.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'lunax-case-study' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Case Study', 'lunax-essential' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Subtitle', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					...
					'space-between' => [
						'title' => esc_html__( 'Space Between', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			'arrows_margin',
			[
				'label'      => esc_html__( 'Wrapper Margin', 'lunax-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
