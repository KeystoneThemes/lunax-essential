...
use LunaxEssentialApp\Inc\WDB_Walker_Elementor_Footer_Nav;
...
class Footer_Menu extends Widget_Base {
    ...
    public function get_style_depends() {
        wp_register_style( 'wdb-navigation-menu', LUNAX_ESSENTIAL_ASSETS_URL . 'css/navigation.css' );
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'inline_menu_content',
            [
                'label' => esc_html__( 'Select Navigation & Style', 'lunax-essential' ),
            ]
        );
            $this->add_control(
                'inline_menu_style',
                [
                    ...
                    'default' => '1',
                    'options' => [
                        '1'      => esc_html__( 'Style One', 'lunax-essential' ),
                        '2'      => esc_html__( 'Style Two', 'lunax-essential' ),
                        '3'      => esc_html__( 'Style Three', 'lunax-essential' ),
                        // '4'      => esc_html__( 'Badge Menu', 'lunax-essential' ),
                        // 'custom' => esc_html__( 'Custom Style', 'lunax-essential' ),
                    ],
                ]
            );            
            ...
            $this->add_control(
                'menu_right_icon',
                [
                    'label' => esc_html__( 'Nav Arrow Icon', 'lunax-essential' ),
            ...
            $this->add_control(
                'icon_left',
                [
                    'label' => esc_html__( 'Icon Left ?', 'lunax-essential' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => esc_html__( 'Yes', 'lunax-essential' ),
                    'label_off' => esc_html__( 'No', 'lunax-essential' ),
                    'return_value' => 'yes',
            ...
            if ( ! empty( $this->get_available_menus() ) ) {
                $this->add_control(
                    ...
                    [
                        ...
                        'save_default' => true,
                        'description'  => sprintf( esc_html__( 'Go to the <a href="%s" target="_blank">Menus Option</a> to manage your menus.', 'lunax-essential' ), admin_url( 'nav-menus.php' ) ),
                        'separator'    => 'before',
                    ]
                );
            } else {
                $this->add_control(
                    ...
                    [
                        ...
                        'raw'       => sprintf( esc_html__( '<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus Option</a> to create one.', 'lunax-essential' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
                        'separator' => 'before',
                    ]
                );
            }
            $this->add_control(
                'menu_depth',
                [
                    'label' => esc_html__( 'Menu Depth', 'lunax-essential' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Menu Items', 'lunax-essential' ),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'block'        => esc_html__( 'Block', 'lunax-essential' ),
                        'inline-block' => esc_html__( 'Inline Block', 'lunax-essential' ),
                        'flex'         => esc_html__( 'Flex', 'lunax-essential' ),
                        'inline-flex'  => esc_html__( 'Inline Flex', 'lunax-essential' ),
                        'inherit'      => esc_html__( 'Inherit', 'lunax-essential' ),
            ...
            $this->add_responsive_control(
                'menu_items_float',
                [
                    'label'   => esc_html__( 'Float', 'lunax-essential' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'none',
                    'options' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'justify' => [
                            'title' => esc_html__( 'Justify', 'lunax-essential' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Single Menu Item', 'lunax-essential' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
            // Menu Normal Tab
            $this->start_controls_tabs( 'menu_style_tabs' );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => esc_html__( 'Background', 'lunax-essential' ),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'default' => 'block',
                            'options' => [
                                ''      => esc_html__( 'list-item', 'lunax-essential' ),
                                'block'        => esc_html__( 'Block', 'lunax-essential' ),
                                'inline-block' => esc_html__( 'Inline Block', 'lunax-essential' ),
                                'flex'         => esc_html__( 'Flex', 'lunax-essential' ),
                                'inline-flex'  => esc_html__( 'Inline Flex', 'lunax-essential' ),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'   => esc_html__( 'List Style', 'lunax-essential' ),
                            'type'    => Controls_Manager::SELECT,
                            'default' => 'none',
                            'condition' => [
                                'menu_display' => ['']
                            ...
                            'options' => [
                                'none'                 => esc_html__('None','lunax-essential'),
                                'disc'                 => esc_html__('Disc','lunax-essential'),
                                'circle'               => esc_html__('Circle','lunax-essential'),
                                'square'               => esc_html__('Square','lunax-essential'),
                                'decimal'              => esc_html__('Decimal','lunax-essential'),
                                'decimal-leading-zero' => esc_html__('Decimal-leading-zero','lunax-essential'),
                                'bengali'          => esc_html__('bengali','lunax-essential'),
                                'lower-roman'          => esc_html__('Lower Roman','lunax-essential'),
                                'upper-roman'          => esc_html__('Upper Roman','lunax-essential'),
                                'lower-greek'          => esc_html__('Lower Greek','lunax-essential'),
                                'lower-latin'          => esc_html__('Lower Latin','lunax-essential'),
                                'upper-latin'          => esc_html__('Upper Latin','lunax-essential'),
                                'armenian'             => esc_html__('Armenian','lunax-essential'),
                                'georgian'             => esc_html__('Georgian','lunax-essential'),
                                'lower-alpha'          => esc_html__('Lower Alpha','lunax-essential'),
                                'upper-alpha'          => esc_html__('Upper Alpha','lunax-essential'),
                            ],
                            'selectors' => [                                
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'options' => [
                                'initial'  => esc_html__( 'Initial', 'lunax-essential' ),
                                'relative' => esc_html__( 'Relative', 'lunax-essential' ),
                                'static'   => esc_html__( 'Static', 'lunax-essential' ),
                            ],
                            'selectors' => [
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'     => esc_html__( 'Border', 'lunax-essential' ),
                            'selector'  => '{{WRAPPER}} .single__menu__nav .wdb__menu li a',
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'     => esc_html__( 'Box Shadow', 'lunax-essential' ),
                            'selector'  => '{{WRAPPER}} .single__menu__nav .wdb__menu li a',
                            'separator' => 'before',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    [
                        'label' => esc_html__( 'Active', 'lunax-essential' ),
                    ]
                );
        ...
        $this->start_controls_section(
            'badge_style_section',
            [
                'label'     => esc_html__( 'Badge', 'lunax-essential' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_menu_bedge' => 'yes',
                ]
