...
class Landing_Page extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				'wdbin_se_pg',
				[
					'label' => esc_html__( 'Main Padding', 'lunax-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'CTA Button', 'lunax-essential' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Text Hover Color', 'lunax-essential' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'cta_icon_color',
				[
					'label' => esc_html__( 'Icon Color', 'lunax-essential' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mobile Interface', 'lunax-essential' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'General', 'lunax-essential' ),
			]
		);
			...
			$this->add_responsive_control(
				'mobile_logo_width',
				[
					'label'              => __( 'Mobile Bar Width', 'lunax-essential' ),
			...
			$this->add_responsive_control(
				'containersty_width',
				[
					'label'              => __( 'Main Container Width', 'lunax-essential' ),
					'type'               => Controls_Manager::SLIDER,
					'default'            => [
						'unit' => '%',
					],
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Transparent Menu ?', 'lunax-essential' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '',
					'options' => [
						'' => esc_html__( 'Yes', 'lunax-essential' ),
						'relative' => esc_html__( 'No', 'lunax-essential' ),					
			...
			$this->add_control(
				'mobile_bar_direc',
				[
					'label' => esc_html__( 'Bar Direction', 'lunax-essential' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '',
					'options' => [
						'' => esc_html__( 'Default', 'lunax-essential' ),
						'row' => esc_html__( 'Row', 'lunax-essential' ),
						'row-reverse'  => esc_html__( 'Row Reverse', 'lunax-essential' ),
						'column' => esc_html__( 'Column', 'lunax-essential' ),
						'column-reverse' => esc_html__( 'Column Reverse', 'lunax-essential' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Mobile Padding', 'lunax-essential' ),
					'type' => \Elementor\Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],					
					'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Link Color', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function register_content_site_logo_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' => 'one',
					'options' => [
						'one'   => esc_html__( 'One' , 'lunax-essential' ),
						'two'       => esc_html__( 'Two' , 'lunax-essential' )		
					],
		...
		$this->start_controls_section(
			'section_site_image',
			[
				'label' => __( 'Menu Settings', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			'custom_image',
			[
				'label'     => __( 'Logo / Image', 'lunax-essential' ),
		...
		$this->add_group_control(
			...
			[
				'name'    => 'site_logo_size',
				'label'   => __( 'Image Size', 'lunax-essential' ),
				'default' => 'medium',				
			]
		);
		...
		$this->add_control(
			'menu_list',
			[
				'label' => esc_html__( 'Menu List', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'list_title' => esc_html__( 'Home', 'lunax-essential' ),						
					],					
				],
		...
		$this->start_controls_section(
			'section_logoimage',
			[
				'label' => __( 'Mobile Interface', 'lunax-essential' ),
			]
		);
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				'custom_mobile_image',
				[
					'label'     => __( 'Mobile Logo', 'lunax-essential' ),
					'type'      => Controls_Manager::MEDIA,
					'dynamic'   => [
						'active' => true,
					],
			...
			$this->add_control(
				'custom_bar',
				[
					'label'       => __( 'Custom Mobile Bar', 'lunax-essential' ),
			...
			$this->add_control(
				'bar',
				[
					'label' => esc_html__('Mobile Bar', 'lunax-essential'),
			...
			$this->add_control(
				'custom_bar_image',
				[
					'label' => esc_html__( 'Choose mobile Bar Image', 'lunax-essential' ),
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				'close_icon',
				[
					'label' => esc_html__( 'Close Icon', 'lunax-essential' ),
					'type' => \Elementor\Controls_Manager::ICONS,
					'default' => [					
					]				
				]
		...
		$this->start_controls_section(
			'section_cta_button',
			[
				'label' => __( 'Cta Button', 'lunax-essential' ),
				'condition' => ['preset_style' => ['two']]
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => esc_html__( 'Get Started Now', 'lunax-essential' ),
					'placeholder' => esc_html__( 'Get Started Now', 'lunax-essential' ),
				]
			);
			...
			$this->add_control(
				'show_cta_icon',
				[
					'label' => esc_html__( 'Cta Cta Icon', 'lunax-essential' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'lunax-essential' ),
					'label_off' => esc_html__( 'Hide', 'lunax-essential' ),
					'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_additional',
			[
				'label' => __( 'Additional Settings', 'lunax-essential' ),
			]
		);
		...
		$this->add_responsive_control(
			'align',
			[
				'label'              => __( 'Alignment', 'lunax-essential' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => [
					'left'   => [
						'title' => __( 'Left', 'lunax-essential' ),
						'icon'  => 'eicon-text-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'lunax-essential' ),
						'icon'  => 'eicon-text-align-center',
					],
					'right'  => [
						'title' => __( 'Right', 'lunax-essential' ),
		...
		$this->add_control(
			'enable_url_attr',
			[
				'label' => esc_html__( 'Enable Url Attribute', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'mobile_direction',
			[
				'label' => esc_html__( 'Mobile Content Direction', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
	...
	protected function register_site_logo_styling_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Site logo', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container Padding', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],				
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'options' => [
					'unset' => esc_html__( 'Default', 'lunax-essential' ),
					'100/100' => esc_html__( '100/100', 'lunax-essential' ),			
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'width',
			[
				'label'              => __( 'Width', 'lunax-essential' ),
				'type'               => Controls_Manager::SLIDER,
				'default'            => [
					'unit' => '%',
				],
		...
		$this->add_responsive_control(
			'space',
			[
				'label'              => __( 'Max Width', 'lunax-essential' ) . ' (%)',
				'type'               => Controls_Manager::SLIDER,
				'default'            => [
					'unit' => '%',
				],
		...
		$this->add_control(
			'logo_text_color',
			[
				'label'     => __( 'Border Color', 'lunax-essential' ),
		...
		$this->start_controls_tab(
			'normal',
			[
				'label' => __( 'Normal', 'lunax-essential' ),
			]
		);
			...
			$this->add_control(
				'opacity',
				[
					'label'     => __( 'Opacity', 'lunax-essential' ),
					'type'      => Controls_Manager::SLIDER,
					'range'     => [
						'px' => [
							'max'  => 1,
		...
		$this->start_controls_tab(
			'hover',
			[
				'label' => __( 'Hover', 'lunax-essential' ),
			]
		);
			...
			$this->add_control(
				...
				[
					'label'     => __( 'Transition Duration', 'lunax-essential' ),
					'type'      => Controls_Manager::SLIDER,
					'range'     => [
						'px' => [
							'max'  => 3,
	...
	protected function register_site_logo_caption_styling_controls() {
		...
		$this->add_control(
			'text_color',
			[
				'label'     => __( 'Text Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'text_active_color',
			[
				'label'     => __( 'Active Border Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [				
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Active Text & Icon Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Typhography', 'lunax-essential' ),
		...
		$this->add_control(
			'text_hover_color',
			[
				'label'     => __( 'Text Hover Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Hover Typhography', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Background Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'caption_padding',
			[
				'label'              => __( 'Item Padding', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			'cmenu_wrap_marg',
			[
				'label'              => __( 'Menu Wrapper Margin', 'lunax-essential' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => [ 'px', 'em', '%' ],
				'selectors'          => [
	...
	public function site_image_url( $size ) {
		...
		if ( ! empty( $settings['custom_image']['url'] ) ) {
			...
			$logo            = lunax_option( 'logo', $light_logo ); 				
			return $logo;
		}
	...
	protected function render() {
		...
		if(file_exists(LUNAX_ESSENTIAL_DIR_PATH."widgets/landing-pages/content-$preset_style".'.php')){ 
			include_once(LUNAX_ESSENTIAL_DIR_PATH."widgets/landing-pages/content-$preset_style".'.php'); 
		}	
	}
