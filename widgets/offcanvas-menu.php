...
class Offcanvas_Menu extends Widget_Base {
	...
	public function logo_image_url( $size ) {
		...
		if ( ! empty( $settings['custom_image']['url'] ) ) {
			...
			$light_logo = LUNAX_IMG . '/lawyer-black-logo.png';
			$logo       = lunax_option( 'offcanvas_logo', $light_logo );
	...
	public function get_all_images_urls() {
		$returns_data = [];
		$media_dir    = LUNAX_ESSENTIAL_DIR_PATH . 'assets/images/bars/';
		$url_path     = LUNAX_ESSENTIAL_ASSETS_URL . 'images/bars/';
		try {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'menu_button_text',
			[
				'label'       => esc_html__( 'Button Text', 'lunax-essential' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => esc_html__( 'Menu', 'lunax-essential' ),
		...
		$this->add_control(
			'custom_bar',
			[
				'label'   => __( 'Custom Bar', 'lunax-essential' ),
		...
		$this->add_control(
			'bar',
			[
				'label'     => esc_html__( 'Bar', 'lunax-essential' ),
		...
		$this->add_control(
			'sticky_bar',
			[
				'label'   => __( 'Sticky Bar', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'preset'              => esc_html__( 'Preset', 'lunax-essential' ),
					'elementor_shortcode' => esc_html__( 'Custom Shortcode', 'lunax-essential' ),
		...
		$this->add_control(
			'preset_style',
			[
				'label'     => esc_html__( 'Preset Style', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => 'two',
				'options'   => [
					'two' => esc_html__( 'One', 'lunax-essential' ),
//						'three'     => esc_html__( 'Two' , 'lunax-essential' ),
//						'four'      => esc_html__( 'Three' , 'lunax-essential' ),
//						'five'      => esc_html__( 'Four' , 'lunax-essential' ),
//						'six'       => esc_html__( 'Five' , 'lunax-essential' ),
		...
		$this->add_control(
			'shortcode',
			[
				'label'       => esc_html__( 'Elementor Template ShortCode', 'lunax-essential' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => esc_html__( '[WDB_ELEMENTOR_TPL id="1951"]', 'lunax-essential' ),
		...
		$this->add_control(
			'show_logo',
			[
				'label'        => esc_html__( 'Show Logo / Custom Image', 'lunax-essential' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'lunax-essential' ),
				'label_off'    => esc_html__( 'Hide', 'lunax-essential' ),
				'return_value' => 'yes',
				'default'      => 'yes',
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => esc_html__( 'List Title', 'lunax-essential' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Email', 'lunax-essential' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'email'   => esc_html__( 'Email', 'lunax-essential' ),
					'phone'   => esc_html__( 'Phone', 'lunax-essential' ),
					'address' => esc_html__( 'Address', 'lunax-essential' ),
				],
			]
		);
		...
		$repeater->add_control(
			'link',
			[
				'label'       => esc_html__( 'Link Value', 'lunax-essential' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '#',
				'label_block' => true,
		...
		$this->add_control(
			'contact_info',
			[
				'label'       => esc_html__( 'Contact Info', 'lunax-essential' ),
		...
		$this->add_control(
			'language_info',
			[
				'label'       => esc_html__( 'Language Info', 'lunax-essential' ),
				'type'        => \Elementor\Controls_Manager::REPEATER,
		...
		$this->add_control(
			'copyright_texts',
			[
				'label'       => esc_html__( 'Copyright', 'lunax-essential' ),
		...
		$this->start_controls_section(
			'section_close_area',
			[
				'label' => esc_html__( 'Close Button', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Default?', 'lunax-essential' ),
				'type'    => Controls_Manager::SWITCHER,
				'yes'     => __( 'Yes', 'lunax-essential' ),
				'no'      => __( 'No', 'lunax-essential' ),
				'default' => 'yes',
		...
		$this->add_control(
			'close_text',
			[
				'label'       => esc_html__( 'Close Text', 'lunax-essential' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => 'close',
				'placeholder' => esc_html__( 'close text', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			'close_position_type',
			[
				'label'     => esc_html__( 'Position', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''                                                         => esc_html__( 'Default', 'lunax-essential' ),
					'position: absolute;right: 50px;top: 50px; z-index: 1;'    => esc_html__( 'Right Top', 'lunax-essential' ),
					'position: absolute;left: 50px;top: 50px; z-index: 1;'     => esc_html__( 'Left Top', 'lunax-essential' ),
					'position: absolute;left: 50px;bottom: 50px; z-index: 1;'  => esc_html__( 'Left Bottom', 'lunax-essential' ),
					'position: absolute;right: 50px;bottom: 50px; z-index: 1;' => esc_html__( 'Right Bottom', 'lunax-essential' ),
				],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Main Container', 'lunax-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Open Text Button', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Text Shadow', 'lunax-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Close Icon Button', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Icon Background', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Icon Wrapper Width', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Icon Wrapper Height', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Close Text Button', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'nav_off_h_menucolor',
			[
				'label'     => esc_html__( 'Hover Color', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			'menu_hht_auto',
			[
				'label'     => esc_html__( 'Height Auto', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'No', 'lunax-essential' ),
					'auto' => esc_html__( 'Yes', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			'off_menu_dp_padding',
			[
				'label'      => esc_html__( 'Level Two Padding', 'lunax-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors'  => [
		...
		$this->add_control(
			'menu_icon_heading',
			[
				'label' => esc_html__( 'Menu Icon', 'lunax-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Contact', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'contact_display',
			[
				'label'     => esc_html__( 'Display', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'Default', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Heading Color', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Body Color', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Copyright , Search , Lang', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'footer_c_display',
			[
				'label'     => esc_html__( 'Copyright Display', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'Default', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Copyright Color', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Copyright Link Color', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'footer_s_display',
			[
				'label'     => esc_html__( 'Search Display', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'Default', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Search Input Color', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'footer_l_display',
			[
				'label'     => esc_html__( 'Lang Display', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'Default', 'lunax-essential' ),
		...
		$this->add_control(
			'nav_off_lang_color',
			[
				'label'     => esc_html__( 'Language Color', 'lunax-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Offcanvas Right', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Offcanvas Left', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		<?php if ( $settings['content_source'] === 'preset' ) { ?>
			<?php include_once( LUNAX_ESSENTIAL_DIR_PATH . "widgets/offcanvas-preset/content-$preset_style" . '.php' ); ?>
		<?php } else { ?>
			<?php include_once( LUNAX_ESSENTIAL_DIR_PATH . "widgets/offcanvas-preset/content-elementor.php" ); ?>
		<?php } ?>
		<?php
	}
}