...
class Lunax_Gallery extends Widget_Base {

	public function get_name() {
		return 'lunax--gallery';
	}

	public function get_title() {
		return esc_html__( 'Lunax Gallery', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax-gallery', LUNAX_ESSENTIAL_ASSETS_URL . 'css/lunax-gallery.css' );

		return [ 'lunax-gallery' ];
	}

	public function get_script_depends() {
		wp_register_script( 'lunax-gallery', LUNAX_ESSENTIAL_ASSETS_URL . '/js/widgets/lunax-gallery.js', [ 'jquery' ], false, true );
	...
	protected function register_controls() {
		$this->start_controls_section(
			'sec_gallery',
			[
				'label' => __( 'Gallery', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Case Study', 'lunax-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'g_title_tag',
			[
				'label'   => esc_html__( 'HTML Tag', 'lunax-essential' ),
	...
	protected function gallery_slider_one_controls() {
		$this->start_controls_section(
			'sec_g_slider',
			[
				'label' => __( 'Gallery Slider One', 'lunax-essential' ),
			]
		);
		...
		$g_slider->add_control(
			'gs_source',
			[
				'label'   => esc_html__( 'Type', 'lunax-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'image',
				'options' => [
					'image' => esc_html__( 'Image', 'lunax-essential' ),
					'video' => esc_html__( 'Video', 'lunax-essential' ),
				],
			]
		);
		...
		$g_slider->add_control(
			...
			[
				'label'       => esc_html__( 'Title', 'lunax-essential' ),
				'type'        => Controls_Manager::TEXT,
				'default' => __( 'Mastartery', 'lunax-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$g_slider->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default' => __( 'Design - 2019', 'lunax-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'gs_items',
			[
				'label'       => esc_html__( 'Gallery Slider Items', 'lunax-essential' ),
		...
		$this->add_control(
			'gs_title_tag',
			[
				'label'   => esc_html__( 'Title HTML Tag', 'lunax-essential' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'h1'   => 'H1',
					'h2'   => 'H2',
	...
	protected function gallery_slider_two_controls() {
		$this->start_controls_section(
			'sec_g_slider_2',
			[
				'label' => __( 'Gallery Slider Two', 'lunax-essential' ),
			]
		);
	...
	public function register_style_controls() {
		...
		$this->start_controls_section(
			'sec_style_item',
			[
				'label' => esc_html__( 'Gallery', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			'img_vdo_height',
			[
				'label' => esc_html__( 'Image/Video Height', 'lunax-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'separator' => 'before',
				'range' => [
		...
		$this->start_controls_section(
			'sec_style_circle',
			[
				'label' => esc_html__( 'Circle', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'progress_size',
			[
				'label' => esc_html__( 'Progress Size', 'lunax-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
