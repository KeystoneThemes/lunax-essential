...
class Lunax_Posts extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Posts', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax-button', LUNAX_ESSENTIAL_ASSETS_URL . 'css/lunax-button.css' );
		wp_register_style( 'lunax-posts', LUNAX_ESSENTIAL_ASSETS_URL . 'css/lunax-post.css' );

		return [ 'lunax-button', 'lunax-posts' ];
	}

	// Content Control
	public function register_content_controls() {
		$this->start_controls_section(
			'lunax_sec_post_layout',
			[
				'label' => __( 'Layout', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			'element_list',
			[
				'label'     => esc_html__( 'Style', 'lunax-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'separator' => 'after',
				'options'   => [
					'1' => esc_html__( 'One', 'lunax-essential' ),
					'2' => esc_html__( 'Two', 'lunax-essential' ),
					'3' => esc_html__( 'Three', 'lunax-essential' ),
					'4' => esc_html__( 'Four', 'lunax-essential' ),
					'5' => esc_html__( 'Five', 'lunax-essential' ),
				],
			]
		);
		...
		$this->add_control(
			'btn_text',
			[
				'label'       => esc_html__( 'Read More Text', 'lunax-essential' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Read More', 'lunax-essential' ),
				'placeholder' => esc_html__( 'Type your text here', 'lunax-essential' ),
				'condition'   => [
					'element_list' => ['2', '4'],
				],
			]
		...
		$this->add_control(
			'btn_icon',
			[
				'label'       => esc_html__( 'Read More Icon', 'lunax-essential' ),
		...
		$this->add_control(
			'author_text',
			[
				'label'       => esc_html__( 'Date Text', 'lunax-essential' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Written by', 'lunax-essential' ),
				'placeholder' => esc_html__( 'Type your text here', 'lunax-essential' ),
				'condition'   => [
					'element_list' => '2',
				],
		...
		$this->add_control(
			'link_icon',
			[
				'label'       => esc_html__( 'Link Icon', 'lunax-essential' ),
				'type'        => Controls_Manager::ICONS,
				'skin'        => 'inline',
				'label_block' => false,
				'default'     => [
		...
		$this->add_control(
			'lunax_show_title',
			[
				'label'     => esc_html__( 'Show Title', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			'lunax_show_excerpt',
			[
				'label'     => esc_html__( 'Show Excerpt', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_show_thumb',
			[
				'label'     => esc_html__( 'Show Thumbnail', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'no',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_show_meta',
			[
				'label'     => esc_html__( 'Show Meta', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_show_author',
			[
				'label'     => esc_html__( 'Show Author', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_show_date',
			[
				'label'     => esc_html__( 'Show Date', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_show_category',
			[
				'label'     => esc_html__( 'Show Category', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_show_comment',
			[
				'label'     => esc_html__( 'Show Comment', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_show_rm',
			[
				'label'     => esc_html__( 'Show Read More', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_show_link',
			[
				'label'     => esc_html__( 'Show Link Icon', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'lunax-essential' ),
				'label_on'  => esc_html__( 'On', 'lunax-essential' ),
		...
		// Query
		$this->start_controls_section(
			'lunax_sec_post_query',
			[
				'label' => __( 'Query', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			'query_type',
			[
				'label'   => esc_html__( 'Query Type', 'lunax-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'post',
				'options' => [
					'post'    => esc_html__( 'Posts', 'lunax-essential' ),
					'archive' => esc_html__( 'Archive', 'lunax-essential' ),
					'related' => esc_html__( 'related', 'lunax-essential' ),
				],
			]
		);
		...
		$this->add_control(
			'posts_id',
			[
				'label'       => esc_html__( 'Include Posts', 'lunax-essential' ),
		...
		$this->add_control(
			'lunax_post_order_by',
			[
				'label'     => esc_html__( 'Order By', 'lunax-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'date',
				'options'   => [
					'date'          => esc_html__( 'Date', 'lunax-essential' ),
					'title'         => esc_html__( 'Title', 'lunax-essential' ),
					'menu_order'    => esc_html__( 'Menu Order', 'lunax-essential' ),
					'modified'      => esc_html__( 'Last Modified', 'lunax-essential' ),
					'comment_count' => esc_html__( 'Comment Count', 'lunax-essential' ),
					'rand'          => esc_html__( 'Random', 'lunax-essential' ),
				],
				'condition' => [
		...
		$this->add_control(
			'lunax_post_order',
			[
				'label'     => esc_html__( 'Order', 'lunax-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'desc',
				'options'   => [
					'asc'  => esc_html__( 'ASC', 'lunax-essential' ),
					'desc' => esc_html__( 'DESC', 'lunax-essential' ),
				],
				'condition' => [
					'query_type' => [ 'post', 'related' ],
				],
		...
		$this->add_control(
			'lunax_posts_ppage',
			[
				'label'     => esc_html__( 'Posts Per Page', 'lunax-essential' ),
	...
	public function register_style_controls() {
		...
		$this->start_controls_section(
			'lunax_style_layout',
			[
				'label' => esc_html__( 'Layout', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			'blog_cols',
			[
				'label'     => esc_html__( 'Columns', 'lunax-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => [
				...
				'selectors' => [
					'{{WRAPPER}} .lunax--post' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_col_gap',
			[
				'label'      => esc_html__( 'Column Gap', 'lunax-essential' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .lunax--post' => 'column-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_row_gap',
			[
				'label'      => esc_html__( 'Row Gap', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .lunax--post' => 'row-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_item_gap',
			[
				'label'      => esc_html__( 'Item Inner Gap', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .lunax--post .item' => 'gap: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .lunax--post .item',
                'condition' => ['element_list' => '4'],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .lunax--post .item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'blog_h_border_color',
			[
				'label'     => esc_html__( 'Border Hover Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .lunax--post .item:hover' => 'border-color: {{VALUE}}',
				],
				'condition' => [
					'element_list' => '1',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .lunax--post .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_item',
			[
				'label'     => esc_html__( 'Item', 'lunax-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => ['3', '5'],
				],
		...
		$this->add_responsive_control(
			'content_width',
			[
				'label'      => esc_html__( 'Width', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .lunax--post .wrapper' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'element_list' =>  '5',
				],
		...
		$this->add_control(
			'item_bg_color',
			[
				'label'     => esc_html__( 'Background Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .lunax--post.post-style-3 .item::after, {{WRAPPER}} .lunax--post .wrapper' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .lunax--post .wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .lunax--post .wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_thumb',
			[
				'label'     => esc_html__( 'Thumbnail', 'lunax-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'lunax_show_thumb' => 'yes',
				],
			]
		);
		...
		$this->add_responsive_control(
			'bthumb_margin',
			[
				'label'      => esc_html__( 'Spacing', 'lunax-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
		...
		$this->start_controls_section(
			'lunax_style_excerpt',
			[
				'label'     => esc_html__( 'Excerpt', 'lunax-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'lunax_show_excerpt' => 'yes',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_meta',
			[
				'label'     => esc_html__( 'Meta', 'lunax-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'lunax_show_meta' => 'yes',
				],
		...
		$this->add_control(
			'separator_color',
			[
				'label'     => esc_html__( 'Separator Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'sec_style_author',
			[
				'label'     => esc_html__( 'Author', 'lunax-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'lunax_show_author' => 'yes',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Image', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Text', 'lunax-essential' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'element_list' => '2',
		...
		$this->add_control(
			'author_name_heading',
			[
				'label'     => esc_html__( 'Name', 'lunax-essential' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'element_list' => '2',
		...
		$this->start_controls_section(
			'sec_style_category',
			[
				'label'     => esc_html__( 'Category', 'lunax-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'lunax_show_category' => 'yes',
				],
			]
		);
		...
		$this->start_controls_section(
			'style_read_more',
			[
				'label'     => esc_html__( 'Read More', 'lunax-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'lunax_show_rm' => 'yes',
					'element_list'   => ['2', '4'],
		...
		$this->add_responsive_control(
			'btn_icon_width',
			[
				'label'     => esc_html__( 'Icon Width', 'lunax-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 100,
		...
		$this->start_controls_section(
			'sec_style_number',
			[
				'label'     => esc_html__( 'Number', 'lunax-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => '1',
				],
	...
	public function register_pagination_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'numbers_and_prev_next' => esc_html__( 'Numbers', 'lunax-essential' ) . ' + ' . esc_html__( 'Previous/Next', 'lunax-essential' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Page Limit', 'lunax-essential' ),
				'default'   => '5',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Shorten', 'lunax-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => [
					'pagination_type' => 'numbers_and_prev_next',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Colors', 'lunax-essential' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function query_arg() {
		...
		if ( 'related' === $this->get_settings( 'query_type' ) && is_singular() ) {
			...
			$query_args['posts_per_page'] = $this->get_settings( 'lunax_posts_ppage' );
		...
		$query_args = [
			'post_type'      => 'post',
			'posts_per_page' => $this->get_settings( 'lunax_posts_ppage' ),
			'paged'          => $this->get_current_page(),
			'order'          => $this->get_settings( 'lunax_post_order' ),
			'orderby'        => $this->get_settings( 'lunax_post_order_by' ),
	...
	protected function render() {
		...
		$lunax_query = $this->get_query();

		?>
        <div class="lunax--post post-style-<?php echo $settings['element_list']; ?>">
			<?php
			$post_count = 1;
			while ( $lunax_query->have_posts() ) {
				$lunax_query->the_post();
		...
		<?php
		$this->render_pagination( $lunax_query );
		wp_reset_postdata();
	}
	...
	protected function render_pagination( $query ) {
		...
		if ( 'numbers_and_prev_next' === $settings['pagination_type'] ) {
			$paginate_args = [
				...
				'before_page_number' => '<span class="elementor-screen-only">' . esc_html__( 'Page', 'lunax-essential' ) . '</span>',
			];
            ...
            <nav <?php $this->print_render_attribute_string( 'pagination' ); ?>
                    aria-label="<?php esc_attr_e( 'Pagination', 'lunax-essential' ); ?>" style="display: flex">
	...
	private function render_post_1( $settings, $post_count ) {
        ...
        <article <?php post_class( 'item' ); ?>>
			<?php
			if ( 'yes' === $settings['lunax_show_thumb'] ) {
				?>
                <div class="thumb">
            ...
            <div class="wrapper">
                <div class="number"><?php if ( $post_count < 9 ) {
						echo esc_html__('0', 'lunax-essential');
					}
					echo $post_count; ?></div>
                <div class="content">
					<?php
					$post_meta = [];
					$category  = lunax_get_random_category();

					if ( 'yes' === $settings['lunax_show_author'] ) {
					...
					if ( 'yes' === $settings['lunax_show_category'] ) {
						$post_meta[] = $category;
					}

					if ( 'yes' === $settings['lunax_show_date'] ) {
						$post_meta[] = get_the_date( get_option( 'date_format' ) );
					}

					if ( 'yes' === $settings['lunax_show_comment'] ) {
						$comments_number = get_comments_number();
						$post_meta[]     = $comments_number > 1 ? sprintf( esc_html__( '%s comments', 'lunax' ), $comments_number ) : sprintf( esc_html__( '%s comment', 'lunax' ), $comments_number );
					}
					?>
					<?php if ( 'yes' === $settings['lunax_show_meta'] ) { ?>
                        <div class="post-meta">
							<?php
							echo lunax_kses( implode( '<span></span>', $post_meta ) );
							?>
                        </div>
					<?php } ?>

					<?php
					if ( 'yes' === $settings['lunax_show_title'] ) {
						?>
                        <h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
						<?php
					}

					if ( 'yes' === $settings['lunax_show_excerpt'] ) {
						?>
                        <div class="cf_text">
							<?php lunax_excerpt( 40, null ); ?>
                        </div>
						<?php
					}
					?>
				...
				<?php
				if ( 'yes' === $settings['lunax_show_link'] ) {
					?>
                    <div class="link-wrap">
                        ...
                        <div class="wc-btn-wrapper style-<?php echo esc_html( $settings['btn_style'] ); ?>">
                            <a href="<?php the_permalink(); ?>" class="wc-btn-group">
                                ...
                                <span class="wc-btn-primary">
                                    <div class="screen-reader-text"><?php echo esc_html__('Read Post Details', 'lunax-essential'); ?></div>
...
//		                $post_meta[] = get_the_date( get_option( 'date_format' ) );
	                ...
	                if ( 'yes' === $settings['lunax_show_comment'] ) {
		                $comments_number = get_comments_number();
		                $post_meta[]     = $comments_number > 1 ? sprintf( "<div class='pmeta'>" . esc_html__( '%s comments', 'lunax' ), $comments_number ) ."</div>" : sprintf( "<div class='pmeta'>" . esc_html__( '%s comment', 'lunax' ), $comments_number ) ."</div>";
	                }
	                ?>
	                <?php if ( 'yes' === $settings['lunax_show_meta'] ) { ?>
                        <div class="post-meta">
