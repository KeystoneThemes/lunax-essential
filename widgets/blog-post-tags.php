...
class Blog_Post_Tags extends \Elementor\Widget_Base {
	...
	public function get_style_depends() {
		wp_register_style( 'meta-info', LUNAX_ESSENTIAL_ASSETS_URL . 'css/meta-info.css' );
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Content', 'lunax-essential' ),
			]
		);
		...
		$this->add_control(
			'prefix',
			[
				'label'   => esc_html__( 'Prefix', 'lunax-essential' ),
		...
		$this->add_control(
			'suffix',
			[
				'label'   => esc_html__( 'Suffix', 'lunax-essential' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( ',', 'lunax-essential' ),
				'placeholder' => esc_html__( 'Enter separator', 'lunax-essential' ),
			]
		);
		...
		$this->add_responsive_control(
			'tags_limit',
			[
				'label' => esc_html__( 'Limit', 'lunax-essential' ),
		...
		$this->add_responsive_control(
			'align',
			[
				'label'     => esc_html__( 'Alignment', 'LUNAX_ESSENTIAL' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'flex-start'   => [
						'title' => esc_html__( 'Left', 'LUNAX_ESSENTIAL' ),
						'icon'  => 'eicon-text-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'LUNAX_ESSENTIAL' ),
						'icon'  => 'eicon-text-align-center',
					],
					'flex-end'  => [
						'title' => esc_html__( 'Right', 'LUNAX_ESSENTIAL' ),
		...
		$this->start_controls_section(
			'section_styles',
			[
				'label' => esc_html__( 'Style', 'LUNAX_ESSENTIAL' ),
		...
		$this->add_responsive_control(
			'col_gap',
			[
				'label'      => esc_html__( 'Column Gap', 'LUNAX_ESSENTIAL' ),
		...
		$this->add_responsive_control(
			'row_gap',
			[
				'label'      => esc_html__( 'Row Gap', 'LUNAX_ESSENTIAL' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'separator_heading',
			[
				'label' => esc_html__( 'Separator', 'LUNAX_ESSENTIAL' ),
		...
		$this->add_control(
			'separator_color',
			[
				'label' => esc_html__( 'Text Color', 'LUNAX_ESSENTIAL' ),
		...
		$this->add_responsive_control(
			'separator_position',
			[
				'label'      => esc_html__( 'Position Horizontal', 'LUNAX_ESSENTIAL' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Position Vertical', 'LUNAX_ESSENTIAL' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'padding',
			[
				'label'      => esc_html__( 'Padding', 'LUNAX_ESSENTIAL' ),
		...
		$this->add_control(
			'border_radius',
			[
				'label'      => esc_html__( 'Border Radius', 'LUNAX_ESSENTIAL' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'transition',
			[
				'label'      => esc_html__( 'Transition', 'LUNAX_ESSENTIAL' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_tab(
			'normal_tab',
			[
				'label' => esc_html__( 'Normal', 'LUNAX_ESSENTIAL' ),
			]
		);
		...
		$this->add_control(
			'color',
			[
				'label'     => esc_html__( 'Color', 'LUNAX_ESSENTIAL' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_tab(
			'hover_tab',
			[
				'label' => esc_html__( 'Hover', 'LUNAX_ESSENTIAL' ),
			]
		);
		...
		$this->add_control(
			'hover_border',
			[
				'label'     => esc_html__( 'Border Color', 'LUNAX_ESSENTIAL' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
