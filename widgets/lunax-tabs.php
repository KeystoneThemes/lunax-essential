 ...
 * @since 1.0.0
 */
class Lunax_Tabs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Tabs', 'lunax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'lunax-tabs', LUNAX_ESSENTIAL_ASSETS_URL . 'css/lunax-tabs.css' );
		return [ 'lunax-tabs' ];
	}

    // Script Dependency
	public function get_script_depends() {
		wp_register_script( 'lunax-tabs', LUNAX_ESSENTIAL_ASSETS_URL . '/js/widgets/lunax-tabs.js', [ 'jquery' ], false, true );
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => esc_html__( 'Tabs', 'lunax-essential' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Tab Title', 'lunax-essential' ),
				'placeholder' => esc_html__( 'Tab Title', 'lunax-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				...
				'rows' => 3,
				'default' => esc_html__( 'Add the best talent on the market, an agile skilled management & seamlessinvolvement', 'lunax-essential' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Tab Content', 'lunax-essential' ),
				'placeholder' => esc_html__( 'Tab Content', 'lunax-essential' ),
		...
		$this->add_control(
			'tabs',
			[
				'label'       => esc_html__( 'Tabs Items', 'lunax-essential' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'tab_title'   => esc_html__( 'Tab Title 1', 'lunax-essential' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'lunax-essential' ),
					],
					[
						'tab_title'   => esc_html__( 'Tab Title 2', 'lunax-essential' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'lunax-essential' ),
					],
					[
						'tab_title'   => esc_html__( 'Tab Title 3', 'lunax-essential' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'lunax-essential' ),
					],
				],
		...
		$this->add_control(
			'view',
			[
				'label'   => esc_html__( 'View', 'lunax-essential' ),
		...
		$this->add_control( 'tabs_direction',
			[
				'label'        => esc_html__( 'Direction', 'lunax-essential' ),
				'type'         => Controls_Manager::CHOOSE,
				'options'      => [
					'column'         => [
						'title' => esc_html__( 'Above', 'lunax-essential' ),
						'icon'  => 'eicon-v-align-top',
					],
					'column-reverse' => [
						'title' => esc_html__( 'Below', 'lunax-essential' ),
						'icon'  => 'eicon-v-align-bottom',
					],
					'row-reverse'    => [
						'title' => esc_html__( 'After', 'lunax-essential' ),
						'icon'  => 'eicon-h-align-' . $end,
					],
					'row'            => [
						'title' => esc_html__( 'Before', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'type'         => Controls_Manager::SELECT,
				'options'      => [
					''        => esc_html__( 'Start', 'lunax-essential' ),
					'center'  => esc_html__( 'Center', 'lunax-essential' ),
					'end'     => esc_html__( 'End', 'lunax-essential' ),
					'stretch' => esc_html__( 'Stretch', 'lunax-essential' ),
				],
				'selectors'    => [
		...
		$this->start_controls_section( 'section_tabs_setting', [
			'label' => esc_html__( 'Settings', 'lunax-essential' ),
		] );

		$this->add_responsive_control(
			'tab_tittle_align',
			[
				'label'     => esc_html__( 'Title Alignment', 'lunax-essential' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'start'  => [
		...
		foreach ( Plugin::$instance->breakpoints->get_active_breakpoints() as $breakpoint_key => $breakpoint_instance ) {
			...
			/* translators: 1: Breakpoint label, 2: `>` character, 3: Breakpoint value. */
				esc_html__( '%1$s (%2$s %3$dpx)', 'lunax-essential' ),
		...
		$this->add_control(
			'breakpoint_selector',
			[
				'label'        => esc_html__( 'Breakpoint', 'lunax-essential' ),
				'type'         => Controls_Manager::SELECT,
				'description'  => esc_html__( 'Note: Choose at which breakpoint tabs will automatically switch to a vertical (“accordion”) layout.', 'lunax-essential' ),
		...
		$this->add_control(
			'navigation_width',
			[
				'label'     => esc_html__( 'Navigation Width', 'lunax-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'unit' => '%',
				],
		...
		$this->add_responsive_control( 'tabs_title_space_between',
			[
				'label'      => esc_html__( 'Gap between tabs', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control( 'tabs_title_spacing',
			[
				'label'      => esc_html__( 'Distance from content', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'icon_wrapper_size',
			[
				'label'      => esc_html__( 'Circle Size', 'lunax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			'sec_style_active', [
				'label' => esc_html__( 'Hover/Active', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wdb--tabs lunax--tabs' );
		?>
