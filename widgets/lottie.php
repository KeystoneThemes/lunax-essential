...
class Lottie extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
			'source',
			[
				'label' => esc_html__( 'Source', 'lunax-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'media_file',
				'options' => [
					'media_file' => esc_html__( 'Media File', 'lunax-essential' ),
					'external_url' => esc_html__( 'External URL', 'lunax-essential' ),
				],
		...
		$this->add_control(
			'source_external_url',
			[
				'label' => esc_html__( 'External URL', 'lunax-essential' ),
				...
				'placeholder' => esc_html__( 'Enter your URL', 'lunax-essential' ),				
			]
		);
		...
		$this->add_control(
			'source_json',
			[
				'label' => esc_html__( 'Upload JSON File', 'lunax-essential' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Trigger', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',		
				'options' => [
					'' => esc_html__( 'None', 'lunax-essential' ),
					'scroll' => esc_html__( 'On Scroll', 'lunax-essential' ),
					'hover' => esc_html__( 'On Hover', 'lunax-essential' ),
					'cursor_move'  => esc_html__( 'Mouse Cursor', 'lunax-essential' ),					
					'click'  => esc_html__( 'On Click', 'lunax-essential' ),					
					'viewport'  => esc_html__( 'Viewport', 'lunax-essential' ),					
				],				
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Pause', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',	
				'condition' => ['wdb_interactivity_event' => ['click','hover','viewport']],
				'options' => [
					'' => esc_html__( 'None', 'lunax-essential' ),
					'onmouseleave' => esc_html__( 'On Mouseleave', 'lunax-essential' ),
					'onclick' => esc_html__( 'On Click', 'lunax-essential' ),						
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Replay', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'condition' => ['wdb_interactivity_event' => ['click','hover','viewport'], 'wdb_interactivity_event_pause!' => ['']],
				'default' => '',				
				'options' => [
					'' => esc_html__( 'None', 'lunax-essential' ),
					'onhover' => esc_html__( 'On Hover', 'lunax-essential' ),
					'onclick' => esc_html__( 'On Click', 'lunax-essential' ),
					'inview'  => esc_html__( 'Viewport', 'lunax-essential' )		
				],				
			]
		);
		...
		$this->add_control(
			'start_point',
			[
				'label' => esc_html__( 'Start Point', 'lunax-essential' ),
		...
		$this->add_control(
			'end_point',
			[
				'label' => esc_html__( 'End Point', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'condition' => ['wdb_interactivity_event' => ['scroll','cursor_move']],
				'size_units' => [ 'px' ],
				'range' => [
		...
		$this->add_control(
			'controls',
			[
				'label' => esc_html__( 'Controls?', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'lunax-essential' ),
				'label_off' => esc_html__( 'No', 'lunax-essential' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'loop_count',
			[
				'label' => esc_html__( 'Times', 'lunax-essential' ),
		...
		$this->add_control(
			'backward',
			[
				'label' => esc_html__( 'Backward Direction?', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'lunax-essential' ),
				'label_off' => esc_html__( 'No', 'lunax-essential' ),
				'condition' => ['wdb_interactivity_event' => ['hover']],
				'return_value' => 'yes',
				'description' => esc_html__('Play it backward.','lunax-essential'),
				'default' => '',
			]
		);		
		...
		$this->add_control(
			'wdb_speed',
			[
				'label' => esc_html__( 'Speed', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Additiuonal Properties', 'lunax-essential' ),
		...
		$this->add_control(
			'wdb_renderer',
			[
				'label' => esc_html__( 'Renderer', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => esc_html__( 'Default', 'lunax-essential' ),
					'svg' => esc_html__( 'Svg', 'lunax-essential' ),
					// 'html' => esc_html__( 'Html', 'lunax-essential' ),
					'canvas'  => esc_html__( 'Canvas', 'lunax-essential' ),					
				],				
			]
		);		
		...
		$this->add_control(
			'intermission',
			[
				'label' => esc_html__( 'Intermission', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'condition' => ['wdb_interactivity_event' => ['']],
				'description' => esc_html__('Duration (in milliseconds) to pause before playing each cycle in a looped animation. Set this parameter to 0 (no pause) or any positive number. ','lunax-essential'),
				'range' => [
					'px' => [
						'min' => 0,
						'max' => 500,
