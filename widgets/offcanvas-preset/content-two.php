    ...
    <div class="open-offcanvas wdb--info-animated-offcanvas"
        ...
        <?php if ( $settings['menu_button_text'] == '' ) { ?>
            <?php if ( $bar != '' ) { ?>
                <img src="<?php echo esc_url( $bar ); ?>" alt="<?php echo esc_html__('Offcanvas Menu Open', 'lunax-essential'); ?>">
                ...
                <?php if ( $settings['show_logo'] == 'yes' ) { ?>
                    <div class="offcanvas__logo-2">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img
                                    src="<?php echo $this->logo_image_url( $size ); ?>" alt="<?php echo esc_html__('Logo', 'lunax-essential'); ?>"></a>
                    </div>
                <?php } ?>
                <?php if ( $contact_info ) { ?>
