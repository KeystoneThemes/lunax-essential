...
class Banner_Breadcrumb extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Breadcrumb', 'lunax-essential' ),				
			]
		);
		...
		$this->add_control(
			'separetor_icon',
			[
				'label' => esc_html__( 'Separetor Icon', 'lunax-essential' ),
		...
		$this->add_control(
			'author_text',
			[
				'label'   => esc_html__( 'Author Heading', 'lunax-essential' ),
		...
		$this->add_control(
			'error_text',
			[
				'label'   => esc_html__( '404 Heading', 'lunax-essential' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '404 Error',	
				'placeholder' => '404',	
			]
		...
		$this->add_control(
			'search_text',
			[
				'label'   => esc_html__( 'Search Heading', 'lunax-essential' ),
				'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
			'show_title',
			[
				'label' => esc_html__( 'Show Heading', 'lunax-essential' ),
		...
		$this->add_control(
			'dynamic_title',
			[
				'label' => esc_html__( 'Dynamic', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
        ...
        $this->add_control(
			'static_text',
			[
				'label'   => esc_html__( 'Heading Text', 'lunax-essential' ),
				'type'    => Controls_Manager::TEXT,
		...
		$this->add_control(
			'classes',
			[
				'label'   => esc_html__( 'CSS Classes', 'lunax-essential' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
				'ai'      => [
					'active' => false,
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					...
					'justify' => [
						'title' => esc_html__( 'Justified', 'lunax-essential' ),
		...
		$this->start_controls_section(
			'section_bread_style',
			[
				'label' => __( 'Breadcrumb Style', 'lunax-essential' ),
    		...
    		$this->add_control(
    			'link_hover_color',
    			[
    				'label'     => esc_html__( 'Link Hover Color', 'lunax-essential' ),
    				'type'      => Controls_Manager::COLOR,
    				'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Icon Options', 'lunax-essential' ),
            ...
            $this->add_control(
    			'title_sepe_color',
    			[
    				'label'     => esc_html__( 'Separetor Color', 'lunax-essential' ),
    				'type'      => Controls_Manager::COLOR,
    				'selectors' => [
    		...
    		$this->add_control(
    			'sepe_icon',
    			[
    				'label' => esc_html__( 'Icon Padding', 'lunax-essential' ),
            ...
            $this->add_control(
                'wrapper_options',
                [
                    'label' => esc_html__( 'Wrapper', 'lunax-essential' ),
                    'type' => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' => __( 'Title Style', 'lunax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'blend_mode',
			[
				'label'     => esc_html__( 'Blend Mode', 'lunax-essential' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					''            => esc_html__( 'Normal', 'lunax-essential' ),
					'multiply'    => 'Multiply',
					'screen'      => 'Screen',
					'overlay'     => 'Overlay',
					'darken'      => 'Darken',
	...
	protected function render() {
        ...
        $separete_icon = lunax_render_elementor_icons($settings['separetor_icon']);
