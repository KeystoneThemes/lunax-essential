...
class Dropdown extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        wp_register_style( 'wdb-thm-dropdown', LUNAX_ESSENTIAL_ASSETS_URL . 'css/dropdown.css' );
	...
	public function register_content_controls(){
		...
		$repeater->add_control(
			'list_url',
			[
				'label' => esc_html__( 'Url', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => '#',
				'label_block' => true,
			]
		...
		$this->add_control(
			'polylang_switcher',
			[
				'label' => esc_html__( 'PolyLang Swicher?', 'lunax-essential' ),
		...
		$this->add_control(
			'list',
			[
				'label' => esc_html__( 'Dropdown Options', 'lunax-essential' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'list_title' => esc_html__( 'Title #1', 'lunax-essential' ),						
					],					
				],
	...
	public function register_style_controls(){
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Select', 'lunax-essential' ),
          ...
          <div class="athletic__header-lang">   
              <?php if($settings['polylang_switcher'] == 'yes' && defined( 'POLYLANG_VERSION' )){                
                echo $langs;
                    ...
                    <select id="lang" aria-label="<?php echo esc_attr__('Select Language', 'lunax-essential'); ?>">
