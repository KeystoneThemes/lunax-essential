...
class Lunax_Button extends Widget_Base {

	public function get_name() {
		return 'wdb--lunax-button';
	}

	public function get_title() {
		return esc_html__( 'Lunax Button', 'lunax-essential' );
	}
	...
	public function register_content_controls() {
		...
		$this->add_control(
			'btn_shape',
			[
				'label' => esc_html__( 'Choose Shape', 'lunax-essential' ),
		...
		$this->add_control(
			'btn_width',
			[
				'label' => esc_html__( 'Button Width', 'lunax-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'prefix_class' => 'lunax-btn-width-',
				'options' => [
					'' => esc_html__( 'Default', 'lunax-essential' ),
					'full' => esc_html__( 'Full Width', 'lunax-essential' ),
				],
				'condition' => [
					'btn_style' => ['3', '4'],
				],
	...
	public function register_style_controls() {
		...
		$this->add_control(
			'btn_crop_b_color_1',
			[
				'label'     => esc_html__( 'Border Color One', 'lunax-essential' ),
		...
		$this->add_control(
			'btn_crop_b_color_2',
			[
				'label'     => esc_html__( 'Border Color Two', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'btn_crop_b_color_3',
			[
				'label'     => esc_html__( 'Border Color Three', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'btn_crop_b_color_4',
			[
				'label'     => esc_html__( 'Border Color Four', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
