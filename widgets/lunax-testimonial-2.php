 ...
 * @since 1.0.0
 */
class Lunax_Testimonial_2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Lunax Testimonial 2', 'lunax-essential' );
	}
	...
	public function get_script_depends() {
		wp_register_script( 'lunax-testimonial-2', LUNAX_ESSENTIAL_ASSETS_URL . '/js/widgets/lunax-testimonial-2.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'lunax-testimonial-2' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'client_heading',
			[
				'label' => esc_html__( 'Client', 'lunax-essential' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	private function slider_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'both',
				'options'   => [
					'both'   => esc_html__( 'Arrows and Pagination', 'lunax-essential' ),
					'arrows' => esc_html__( 'Arrows', 'lunax-essential' ),
					'dots'   => esc_html__( 'Pagination', 'lunax-essential' ),
	...
	private function slider_pagination_style_controls() {
		...
		$this->add_control(
			'bar_fill_color',
			[
				'label'     => esc_html__( 'Fill Color', 'lunax-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		?>
        <style>
        .elementor-widget-lunax--testimonial-2 .prod_testimonial_thumb .swiper-slide {
