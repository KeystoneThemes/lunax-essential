 ...
 */
  ...
  lunax_get_template('health-top-header.php',[], LUNAX_ESSENTIAL_DIR_PATH , LUNAX_ESSENTIAL_DIR_PATH . '/templates/single/template-parts/');
                ...
                <div class="dancer__blogdetails-contentleft <?php echo esc_attr($row_cls['meta']); ?>">                 
                      ...
                      <ul class="dancer__blogdetails-overview">
                        ...
                        <li>
                          ...
                          <span><?php echo get_post_meta(get_the_id(),'lunax_post_views_count',true) ?><br>
                            <?php echo esc_html__('Views','lunax-essential'); ?></span>
                        </li>
                        <?php } ?>
                        <?php if($general_social_share){ ?>
                          <li>
                            ...
                            <span>
                            <!-- 14 <br> -->
                            <?php echo esc_html__('Shares','lunax-essential') ?></span>
                          </li>
