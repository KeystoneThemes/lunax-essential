...
<?php
  ...
  $blog_cat_show    = lunax_option('blog_category','yes');
  $cat              = get_the_category();
  $blog_cat_single  = lunax_option('blog_category_single','no');
          ...
          <div class="col-xxl-12">
            <div class="content">
              ...
              <p><?php
                ...
                echo esc_html__('by','lunax-essential') .' '. $get_author; 
                }
              ?><span></span><?php echo get_the_date(get_option( 'date_format' )); ?>
               <?php if( lunax_option('blog_comment',0) ){ ?>
                <span></span>
                <?php $comments_number = get_comments_number();
                  echo $comments_number > 1 ? sprintf(esc_html__('%s comments','lunax-essential'),$comments_number) : sprintf(esc_html__('%s comment','lunax-essential'),$comments_number);
                } ?>
