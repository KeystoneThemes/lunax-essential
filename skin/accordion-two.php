...
namespace LunaxEssentialApp\Skin\Accordion;
...
class Skin_Accordion_Two extends Skin_Base {
	...
	public function get_title() {
		return __( 'WDB Style Two', 'lunax-essential' );
	}
	...
	public function inner_title_style_control( $element ) {
		$element->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Title Icon', 'lunax-essential' ),
	...
	public function inner_content_style_control( $element ) {
		...
		$element->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Inner Content', 'lunax-essential' ),
				'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => [
					'_skin' => 'skin-wdb-accordion-two',
				],
		...
		$element->add_responsive_control(
			'wdb_inner2_space',
			[
				'label'     => esc_html__( 'Icon Spacing', 'lunax-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
	...
	public function title_style_control( $element ) {
		...
		$element->add_control(
			...
			[
				...
				'options'   => [
					'left'  => [
						'title' => esc_html__( 'Start', 'lunax-essential' ),
						'icon'  => 'eicon-h-align-left',
					],
					'right' => [
						'title' => esc_html__( 'End', 'lunax-essential' ),
	...
	public function title_number_style( $element ) {
		$element->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Number & Line', 'lunax-essential' ),
		...
		$element->add_control(
			'line_heading',
			[
				'label' => esc_html__( 'Line', 'lunax-essential' ),
		...
		$element->add_control(
			'line_bar_color',
			[
				'label'     => esc_html__( 'Line Color', 'lunax-essential' ),
	...
	public function new_feature_controls( $element ) {
		...
		$element->start_controls_section(
			'wdb2_settings',
			[
				'label'     => esc_html__( 'WDB General', 'lunax-essential' ),
				'condition' => [
					'_skin' => 'skin-wdb-accordion-two',
				],
			]
		...
		$element->add_control(
			'default2_active',
			[
				'label'        => esc_html__( 'Default Active', 'lunax-essential' ),
		...
		$element->add_control(
			'title2_icon_after',
			[
				'label'        => esc_html__( 'Title Icon After Title', 'lunax-essential' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'lunax-essential' ),
				'label_off'    => esc_html__( 'No', 'lunax-essential' ),
				'return_value' => 'yes',
		...
		$element->add_control(
			'innericon2_align',
			[
				'label'     => esc_html__( 'Content Alignment', 'lunax-essential' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'row'         => [
						'title' => esc_html__( 'Start', 'lunax-essential' ),
	...
	public function update_controls( $element ) {
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => esc_html__( 'Accordion Title', 'lunax-essential' ),
				'dynamic'     => [
					'active' => true,
				],
				'label_block' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accordion Content', 'lunax-essential' ),
			]
		);
		...
		$repeater->add_control(
			'wdb_content_icon',
			[
				'label' => esc_html__( 'Content Icon', 'lunax-essential' ),
				'type'  => \Elementor\Controls_Manager::ICONS,
			]
		);
