    ...
    function sticky_transparent_option($element){    
            ...
            $element->start_controls_section(
                ...
                [
                    ...
                    'label' => esc_html__( 'WDB Sticky', 'lunax-essential' ),
                ]
            );
                ...
                $element->add_control(
                    'wdb_global_sticky',
                    [
                        'label' => esc_html__( 'Sticky', 'lunax-essential' ),
                ...
                $element->add_responsive_control(
                    'wdb_sticky_type',
                    [
                        'label' => esc_html__( 'Sticky Type', 'lunax-essential' ),
                        'type' => \Elementor\Controls_Manager::SELECT,
                        'default' => '',                       
                        'options' => [

                            'top'    => esc_html__('Top','lunax-essential'),
                ...
                $element->add_control(
                    'wdb_sticky_offset',
                    [
                        'label' => esc_html__( 'Sticky Offset', 'lunax-essential' ),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Z-index', 'lunax-essential' ),
                        'type' => \Elementor\Controls_Manager::NUMBER,
                        'min' => -2000,
                        'max' => 99999,
                        'step' => 5,
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Header Navigation', 'lunax-essential' ),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Menu Color', 'lunax-essential' ),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Menu Hover Color', 'lunax-essential' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [                           
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Svg Icon Color', 'lunax-essential' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $element->add_group_control(
                    ...
                    [
                        ...
                        'label' => esc_html__( 'Menu Typography', 'lunax-essential' ),
