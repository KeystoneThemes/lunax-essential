...
Class Wdb_Mega_Menu_Cpt{
    ...
    function custom_post_type(){
        ...
        register_post_type('wdb-mega-menu-tpl',
            array(
                'labels'      => array(
                    'name'          => __('Mega Menu', 'LUNAX_ESSENTIAL'),
                    'singular_name' => __('Mega Menu', 'LUNAX_ESSENTIAL'),
                ),
                'public'              => true,
    ...
    public function register_sub_menu_post() {       
        add_submenu_page( 'wdb-lunax-theme-parent' , esc_html__( 'Mega Menu','lunax-essential' ) , esc_html__( 'Mega Menu','lunax-essential' ) , 'manage_options' , 'edit.php?post_type='.$this->type);      
    }
    ...
    public function add_buttons_html($post_id){
        ...
        $elementor_link,
        esc_html__('Edit With Elementor','lunax-essential'),
        $post_id,
        esc_html__('Add To Menu','lunax-essential'),
        // $post_id,
        // esc_html__('Edit Here','lunax-essential')
        );       
