...
class Lunax_Banner_Widget extends WP_Widget {
	public function __construct() {
		$widget_opt = array(
			'classname'		 => 'joya-widget cta-ads-banner',
			'description'	 => esc_html__('CTA Banner','lunax-essential')
		);

		parent::__construct( 'joya-cta-banner', esc_html__( 'Lunax Cta Banner', 'lunax-essential' ), $widget_opt );
	}
	...
	public function form( $instance ) {
       ...
       ?>
        ...
        <p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'top_title' ) ); ?>"><?php esc_html_e( 'SubTitle:', 'lunax-essential' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'query_text' ) ); ?>"><?php esc_html_e( 'Query Text:', 'lunax-essential' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>"><?php esc_html_e( 'Button Label:', 'lunax-essential' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'button_text' ) ); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'Button Link:', 'lunax-essential' ); ?></label>
