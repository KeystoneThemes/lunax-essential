...
<div class="wdb-sing-tpl-wrapper">
    <h4><a class="wdb-post-layout-import-modal button button-primary csf--button" data-id="post_layout" href="javascript:void(0)"><?php echo esc_html__('Import From Library','lunax-essential') ?></a> </h4>
