...
<?php
$json_data = lunax_get_config_value_by_name( 'elementor/layouts' );
?>
<script>
...
<div class="wdb-modal wdb--remote-layouts">
    ...
    <div class="wdb-modal__inner">
        ...
        <img src="<?php echo LUNAX_ESSENTIAL_ASSETS_URL . 'images/logo-icon.svg'; ?>" />
        <h2 class="wdb-tpl-layout-header"><?php echo esc_html__( 'Template Layout Import', 'lunax-essential' ) ?></h2>
        ...
        <div class="wdb-content-install">
            <div class="wdb-single-tpl-wrapper">
                ...
                <div hidden class="wdb-pagi-wrapper"><h3><?php echo esc_html__( 'Page:', 'lunax-essential' ); ?></h3>
