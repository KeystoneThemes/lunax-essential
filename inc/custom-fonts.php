...
Class lunax_Custom_Fonts_Family{
    
    public $elementor_local_font = [];
    public $configs              = [];
    public $font_group_key       = 'lunax-custom';
    public $font_group_label     = 'lunax';
    ...
    public function __construct(){ 
        ...
        $this->configs = lunax_get_config_value_by_name('fonts');
        ...
        add_filter( 'lunax_custom_webfonts' , [ $this, 'lunax_custom_webfonts_from_theme' ] , 4 );
        add_filter( 'elementor/document/urls/preview' , [ $this, 'lunax_elementor_editor_url' ] , 4 );
        add_filter( 'elementor/document/urls/wp_preview' , [ $this, 'lunax_elementor_editor_url' ] , 4 );
    ...
    public function register_sub_menu_post() { 
        add_submenu_page( 'wdb-lunax-theme-parent' , 'Custom Fonts' , 'Custom Fonts' , 'manage_options' , "edit.php?post_type=$this->post_type" );      
    }
    ...
    function custom_post_type(){
        ...
        register_post_type($this->post_type,
          array(
            'labels'      => array(
              'name'          => __('Custom Fonts', 'LUNAX_ESSENTIAL'),
              'singular_name' => __('Custom Font', 'LUNAX_ESSENTIAL'),
            ),
              'public'              => true,
    ...
    public function lunax_elementor_editor_url( $url ){
      return add_query_arg( 'wdb-edit', 1 , $url ); 
    }
    
    function lunax_custom_webfonts_from_theme( $return_fonts ){
           
        $body_font_typho      = lunax_option('opt-tabbed-general');
    ...
    public function get_custom_font_from_user(){
        ...
        foreach($latest_posts as $item){
            ...
            $variation = get_post_meta( $item->ID , 'lunax_custom_fonts_options', true);
