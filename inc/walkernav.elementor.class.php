    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        */
        ...
        if ( $this->elementor_settings['has_dropdown_arrow_icon'] && $depth === 0 && in_array('menu-item-has-children', $classes)) {
            $item_output .= \LunaxEssentialApp\Inc\Iinherit\Wdb_Icon_Manager::render_icon( $this->elementor_settings['menu_down_icon'] );
        }
        
        if ( $this->elementor_settings['has_right_arrow_icon'] && $depth > 0 && in_array('menu-item-has-children', $classes)) {
            $item_output .= \LunaxEssentialApp\Inc\Iinherit\Wdb_Icon_Manager::render_icon( $this->elementor_settings['menu_right_icon'] );
        }
