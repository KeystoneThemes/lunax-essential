...
function lunax_register_site_dynamic_tag_group( $dynamic_tags_manager ) {

	$dynamic_tags_manager->register_group(
		'wdb',
		[
			'title' => esc_html__( 'WDB', 'lunax-essential' )
		]
	);

}
add_action( 'elementor/dynamic_tags/register', 'lunax_register_site_dynamic_tag_group' );
