...
Class Lunax_Additional_Icon{
    ...
    public function theme_custom_icon_manager($settings){
        ...
        $json_data = LUNAX_ESSENTIAL_URL . 'assets/js/elementor-icon.js';

        $settings['lunax-icon-set'] = [
           'name'          => 'wdb-icon-set',
           'label'         => esc_html__( 'Lunax Icons', 'lunax-essential' ),
           'url'           => LUNAX_CSS . '/custom-icons.css',
           'enqueue'       => [ LUNAX_CSS . '/custom-icons.css' ],
           'prefix'        => 'lunax-',
           'displayPrefix' => 'lunax-theme',
