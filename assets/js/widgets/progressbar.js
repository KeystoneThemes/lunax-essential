(function ($) {
     ...
     */
    var LunaxProgressBar = function ($scope, $) {
        let wrapper = $scope.find('.lunax_progressbar');
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/lunax--progressbar.default', LunaxProgressBar);
    });
})(jQuery);