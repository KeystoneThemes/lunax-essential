...
(function ($) {
     ...
     */
    const LunaxVideoSlider = function ($scope, $) {
        const slider = $($('.lunax_video_slider', $scope)[0]);
        const sliderSettings = $($('.lunax_vs_wrapper', $scope)[0]).data('settings') || {};
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/lunax--video-slider.default', LunaxVideoSlider);
    });
})(jQuery);
