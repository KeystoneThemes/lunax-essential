...
(function ($) {
     ...
     */
    const LunaxSideHeader = function ($scope, $) {
        let menu_open = $('.menu--open', $scope);
        let menu_close = $('.menu--close', $scope);
        let side_header = $('.lunax--side-header', $scope);
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/lunax--side-header.default', LunaxSideHeader);
    });
})(jQuery);