<?php
namespace LunaxEssentialApp\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		//Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'lunax-essential' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'lunax-essential' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'lunax-essential' ),
			]
		);
